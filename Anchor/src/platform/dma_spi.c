...
#define PORT_DMA_START_TX_FAST 	{DMA_TX_CH->CCR |= DMA_CCR_EN;}
#define PORT_DMA_STOP_TX_FAST 	{DMA_TX_CH->CCR &= ~DMA_CCR_EN;}
#define PORT_DMA_START_RX_FAST 	{DMA_RX_CH->CCR |= DMA_CCR_EN;}
#define PORT_DMA_STOP_RX_FAST 	{DMA_RX_CH->CCR &= ~DMA_CCR_EN;}
