...
#if (DR_DISCOVERY == 0)
                    uint8 eui64[8] ;
                    memcpy(inst->eui64, &inst->payload.anchorAddress, ADDR_BYTE_SIZE_L);
