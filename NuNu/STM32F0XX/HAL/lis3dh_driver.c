...
u8_t LIS3DH_ReadReg(u8_t Reg, u8_t* Data) {
	...
	while(I2C_GetFlagStatus( I2C1, I2C_ISR_BUSY) != RESET)
	{
		if((LIS3DH_Timeout--) == 0)
		{
			UsartPrintf("Fail I2C_ISR_BUSY\r\n");
			return MEMS_ERROR;
		}
	}

	/* Configure slave address, nbytes, reload, end mode and start or stop generation */
	I2C_TransferHandling(I2C1, LIS3DH_MEMS_I2C_ADDRESS, 1, I2C_SoftEnd_Mode, I2C_Generate_Start_Write);
	...
	while(I2C_GetFlagStatus( I2C1 , I2C_ISR_TC) == RESET)
	{
		if((LIS3DH_Timeout--) == 0)
		{
			UsartPrintf("Fail I2C_ISR_TC\r\n");
			return MEMS_ERROR;
		}
	}

	/* Configure slave address, nbytes, reload, end mode and start or stop generation */
	I2C_TransferHandling( I2C1, LIS3DH_MEMS_I2C_ADDRESS, 1, I2C_AutoEnd_Mode, I2C_Generate_Start_Read);
	...
	*Data = I2C_ReceiveData( I2C1);
	...
	while(I2C_GetFlagStatus( I2C1, I2C_ISR_STOPF) == RESET)
	{
		if((LIS3DH_Timeout--) == 0)
		{
			UsartPrintf("Fail I2C_ISR_STOPF\r\n");
			return MEMS_ERROR;
		}
	}
...
u8_t LIS3DH_WriteReg(u8_t WriteAddr, u8_t Data) {
	...
	/* Configure slave address, nbytes, reload, end mode and start or stop generation */
	I2C_TransferHandling(I2C1, LIS3DH_MEMS_I2C_ADDRESS, 1, I2C_Reload_Mode, I2C_Generate_Start_Write);
	...
	while(I2C_GetFlagStatus(I2C1, I2C_ISR_TCR) == RESET)
	{
		if((LIS3DH_Timeout--) == 0)
		{
			UsartPrintf("Fail I2C_ISR_TCR\r\n");
			return MEMS_ERROR;
		}
	}

	/* Configure slave address, nbytes, reload, end mode and start or stop generation */
	I2C_TransferHandling(I2C1, LIS3DH_MEMS_I2C_ADDRESS, 1, I2C_AutoEnd_Mode, I2C_No_StartStop);
